...
export default function OrderMenuView() {
  ...
  return (
    /* suppressHydrationWarning stops browser plugin element injection from crashing React */
    <div suppressHydrationWarning className="min-h-screen bg-[#0b102e] text-white">
      {/* Top bar */}
          ...
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="min-w-0">
                ...
                <div className="text-[11px] text-white/60 truncate">Menu</div>
              </div>
            </div>
      ...
      {/* Content */}
      <div className="mx-auto w-full max-w-5xl px-4 py-6 pb-44">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 border-t border-white/10 bg-black/35 backdrop-blur-xl">
        <div className="mx-auto w-full max-w-5xl px-4 py-4 flex flex-col gap-4">
          
          {/* Top Row: Pagination Buttons split left and right */}
          <div className="flex items-center justify-between w-full">
            ...
            <button
              ...
              className="inline-flex h-11 items-center justify-center rounded-2xl bg-brand-gold px-4 text-sm font-extrabold text-brand-navy shadow-[0_18px_55px_rgba(195,160,89,0.28)] transition hover:brightness-110"
            >
              Order Online
            </button>
